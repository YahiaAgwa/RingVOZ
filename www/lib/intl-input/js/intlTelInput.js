   ...
   ********************/
        ...
        _bindDropdownListeners: function() {
            ...
            this.countryList.on("click" + this.ns, ".country", function(e) {
                that._selectListItem($(this));/*select a country in list*/
            });
            // click off to close
        ...
        _selectListItem: function(listItem) {
            ...
            /* special modification HB for hide button when select international mode*/
            if (listItem.attr(countryCodeAttr) == 'us' || listItem.attr(countryCodeAttr) == 'ca') document.getElementById('call').style.visibility='visible';
            else document.getElementById('call').style.visibility='hidden';
